...
import  emogy from '../assets/emotion-smile.svg'
...
export default function TextEditor() {
  ...
  <div className="flex items-center">
    ...
    <div className="flex items-center gap-2 mr-5 border-r border-r-[rgba(0,0,0,0.1)] px-4">
      <button className="rounded-[7px] bg-white shadow-[0_1px_7px_0_rgba(0,0,0,0.09)] p-2 text-black"><img src={bold} alt="Bold" className="w-4 h-4" /></button>
      <button><img src={textItalic} alt="Italic" className="w-4 h-4" /></button>
      <button><img src={textUnderline} alt="Underline" className="w-4 h-4" /></button>
    </div>

    {/* Toolbar buttons */}
    <div className="flex items-center gap-2 mr-5 border-r border-r-[rgba(0,0,0,0.1)] px-4">
      <button><img src={listUndordered} alt="List" className="w-4 h-4" /></button>
      <button><img src={listordered} alt="List Ordered" className="w-4 h-4" /></button>
    </div>
    <div className="flex items-center gap-2">
    <button><img src={quotes} alt="Quotes" className="w-4 h-4" /></button>
      <button><img src={scrips} alt="Scripts" className="w-4 h-4" /></button>
    </div>
  </div>

  {/* Right side (Trash) */}
  <button><img src={trash} alt="Delete" className="w-4 h-4" /></button>
      </div>
      ...
      <div className="flex items-center justify-between mt-3">
        <div className="flex items-center gap-3">
          ...
          <button><img src={emogy} alt="Emoji" className="w-5 h-5" /></button>
